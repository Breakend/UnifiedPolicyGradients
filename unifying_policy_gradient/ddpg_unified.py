...
class DDPG(RLAlgorithm):
    ...
    def train(self, sess=None):
        ...
        pool_on_policy = SimpleReplayPool_On_Policy(
            max_pool_size=self.replay_pool_size,
            observation_dim=self.env.observation_space.flat_dim,
            action_dim=self.env.action_space.flat_dim,
        )
        ...
        with tf.variable_scope("sample_pol"):
        ...
        for epoch in range(self.n_epochs):
            ...
            for epoch_itr in pyprind.prog_bar(range(self.epoch_length)):
                ...
                if not terminal and path_length >= self.max_path_length:
                    ...
                    pool.add_sample(observation, action, reward * self.scale_reward, terminal)
                    pool_on_policy.add_sample(on_policy_next_observation, on_policy_action, on_policy_reward*self.scale_reward, on_policy_terminal)
